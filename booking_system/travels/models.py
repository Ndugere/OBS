...
class Travel(models.Model):
    ...
    duration = models.IntegerField(help_text="Duration of the journey in minutes", default=00)
    ...
    max_capacity = models.PositiveIntegerField(help_text="Maximum seating capacity of the vehicle", default=00)
    ...
    remaining_seats = models.PositiveIntegerField(help_text="Number of seats currently available", default=00)
